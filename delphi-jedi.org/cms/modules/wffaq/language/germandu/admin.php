...
define('_AM_FVALTXT',"Erlaubt dir die L&ouml;schung oder Freigabe der neu eingeschickten FAQ's.");
/*
* Lang defines for Category.php
*/
define('_AM_FRECOUNT','FAQ Themen neu z&auml;hlen');
define('_AM_FRECOUNTTXT','Erlaubt dir die Anzahl der FAQ in jeder Kategorie neu zu z&auml;hlen.');
...
define('_AM_NOTCTREATEDACAT','Du kannst keine FAQ hinzuf&uuml;gen wenn du keine FAQ Kategorie erstellt hast!');
...
*/
define('_AM_VISITSUPPORT', 'Besuche die WF-Section Website f&uuml;r weitere Informationen, Updates und Hinweise f&uuml;r die Benutzung.<br /> WF-FAQ v1 Catzwolf &copy; 2003 <a href="http://wfsections.xoops2.com/" target="_blank">WF-FAQ</a>');
