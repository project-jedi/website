...
function tinycontent_block_nav() {

        global $xoopsDB;
        $block = array();
		$myts =& MyTextSanitizer::getInstance();
		
		$result = $xoopsDB->query("SELECT storyid, blockid, title, visible FROM ".$xoopsDB->prefix('tinycontent')." WHERE visible='1' ORDER BY blockid");
