...
if ($HTTP_POST_VARS["hdn_checkout_cancel_confirm"])
  {
  $query =  "UPDATE ".$xoopsDB->prefix("dms_objects")." ";
  $query .= "SET obj_status='".NORMAL."',obj_checked_out_user_id='0' WHERE obj_id='".$HTTP_POST_VARS["hdn_file_id"]."'";
  $xoopsDB->query($query);
  
  print "<SCRIPT LANGUAGE='Javascript'>\r";
  print "location=\"file_options.php?obj_id=".$HTTP_POST_VARS["hdn_file_id"]."\";";
  print "</SCRIPT>";  
  exit(0);
  }
else
  ...
  print "  <tr><td colspan='2' align='left'><b>Cancel Document Checkout:</b></td></tr>\r";
  print "  <tr><td colspan='2'><BR></td></tr>\r";
  print "  <tr>\r";
  ...
  print "  </tr>\r";
  print "  <tr><td colspan='2'><BR></td></tr>\r";
  print "  <td colspan='2' align='left'><input type=submit name='btn_submit' value='Cancel Checkout'>";
  print "                               <input type=button name='btn_cancel' value='Cancel' onclick='location=\"file_options.php?obj_id=".$HTTP_GET_VARS["file_id"]."\";'></td>\r";
  print "</table>\r";
  print "<input type='hidden' name='hdn_checkout_cancel_confirm' value='confim'>\r";
