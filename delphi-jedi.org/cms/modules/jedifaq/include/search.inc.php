<?php
// $Id: search.inc.php,v 1.5 2003/02/12 11:38:58 okazu Exp $
//  ------------------------------------------------------------------------ //
...
function jedifaq_search($queryarray, $andor, $limit, $offset, $userid)
{
	global $xoopsDB;
	$ret = array();
	if ( $userid != 0 ) {
	...
	$sql = "SELECT contents_id, category_id, contents_title, contents_contents, contents_time FROM ".$xoopsDB->prefix("jedifaq_contents")." WHERE contents_visible=1 ";
