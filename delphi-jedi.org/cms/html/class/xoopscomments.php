<?php
// $Id: xoopscomments.php,v 1.12 2003/07/08 12:38:08 okazu Exp $
//  ------------------------------------------------------------------------ //
...
class XoopsComments extends XoopsObject
{
	...
	{
		global $HTTP_SERVER_VARS, $xoopsConfig, $xoopsUser;
		echo "<form method='get' action='".$HTTP_SERVER_VARS['PHP_SELF']."'><table width='100%' border='0' cellspacing='1' cellpadding='2'><tr><td class='bg1' align='center'><select name='mode'><option value='nocomments'";
		if ( $mode == "nocomments" ) {
