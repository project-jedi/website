<?php
// $Id: notification_update.php,v 1.4 2003/03/30 06:11:45 okazu Exp $
//  ------------------------------------------------------------------------ //
...
$update_list = $HTTP_POST_VARS['not_list'];
...
redirect_header ($HTTP_POST_VARS['not_redirect'].$argstring, 3, _NOT_UPDATEOK);
exit();
