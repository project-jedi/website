<?php
// $Id: comment_delete.php,v 1.12 2003/09/30 06:45:44 okazu Exp $
//  ------------------------------------------------------------------------ //
...
if (!empty($HTTP_POST_VARS)) {
	...
	$com_mode = isset($HTTP_GET_VARS['com_mode']) ? htmlspecialchars(trim($HTTP_GET_VARS['com_mode']), ENT_QUOTES) : 'flat';
	$com_order = isset($HTTP_GET_VARS['com_order']) ? intval($HTTP_GET_VARS['com_order']) : XOOPS_COMMENT_OLD1ST;
