...
'readonly_lag' => "Databáza bola automaticky zamknutá, pokiaľ slave servre nedobehnú master",
...
'prefs-help-userdata' => '¹ Skutočné meno (nepovinné): ak sa rozhodnete ho poskytnúť, 
...
'passwordsentforemailauthentication'
			=> "Nové heslo bolo zaslané na e-mailovú adresu, ktorá bola novo zaregistrovaná pre \"$1\".
...
# switching pan
'userlevels-lookup-group' => 'Spravuj práva skupiny',
'userlevels-group-edit' => 'Existujúce skupiny: ',
'editgroup' => 'Uprav skupinu',
'addgroup' => 'Pridaj skupinu',

'userlevels-lookup-user' => 'Spravuj skupiny redaktorov',
'userlevels-user-editname' => 'Napíš meno redaktora: ',
'editusergroup' => 'Uprav redaktorské skupiny',

# group editing
'userlevels-editgroup' => 'Uprav skupinu',
'userlevels-addgroup' => 'Pridaj skupinu',
'userlevels-editgroup-name' => 'Meno skupiny: ',
'userlevels-editgroup-description' => 'Opis skupiny (max. 255 znakov):<br />',
'savegroup' => 'Ulož skupinu',

# user groups editing
#
'userlevels-editusergroup' => 'Uprav skupinu',
'saveusergroups' => 'Ulož skupinu',
'userlevels-groupsmember' => 'Člen skupiny:',
'userlevels-groupsavailable' => 'Dostupné skupiny:',
'userlevels-groupshelp' => 'Označte skupiny, do ktorých chcete pridať alebo z ktorých chcete
...
'data'	=> 'Dáta',
'userlevels' => 'Spravovanie redaktorských práv',
...
'allpagesformtext1' => 'Zobraz články od článku: $1',
'allpagesformtext2' => 'Vyber menný priestor: $1 $2',
'allarticles'       => 'Všetky články',
'allpagesprev'      => 'Predchádzajúci',
'allpagesnext'      => 'Ďalší',
'allpagesnamespace' => 'Všetky stránky (menný priestor $1)',
'allpagessubmit'    => 'Choď',
...
'noblockreason' => 'Musíte udať dôvod zablokovania.',
...
'sorbs_create_account_reason' => 'Vaša IP adresa je vedená ako nezabezpečený proxy server v [http://www.sorbs.net SORBS] DNSBL. Nemôžete si vytvoriť konto',
