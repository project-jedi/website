...
"longpagewarning" => "PERINGATAN: Halaman ini panjangnya adalah $1 kilobyte; beberapa browser mungkin mengalami masalah dalam menyunting halaman yang panjangnya 32 kB atau lebih. Pertimbangkan memecah halaman menjadi beberapa halaman kecil.",
"readonlywarning" => "PERINGATAN: Basis data sedang dikunci karena pemeliharaan, sehingga saat ini Anda tidak akan dapat menyimpan hasil penyuntingan Anda. Anda mungkin perlu memindahkan hasil penyuntingan Anda ini ke tempat lain untuk disimpan belakangan.",
"protectedpagewarning" => "PERINGATAN:  Halaman ini telah dikunci sehingga hanya pemakai dengan status sysop saja yang dapat menyuntingnya. Pastikan Anda mengikuti <a href='$wgScript/Project:Petunjuk_halaman_dilindungi'>aturan halaman yang dilindungi</a>.",
...
"prefsnologintext" => "Anda harus <a href=\"{{localurl:Special:Userlogin}}\">login</a> untuk menetapkan konfigurasi Anda.",
...
"ilshowmatch" => "Tampilkan semua gambar dengan nama yang cocok dengan",
"ilsubmit" => "Cari",
...
'listadmins' => 'Daftar Administrator',
...
"mailnologintext" => "Anda harus <a href=\"{{localurl:Special:Userlogin\">login</a> dan mempunyai alamat e-mail yang sah di dalam <a href=\"{{localurl:Special:Preferences}}\">konfigurasi</a> untuk mengirimkan e-mail kepada pengguna lain.",
...
"watchnologintext" => "Anda harus <a href=\"{{localurl:Special:Userlogin}}\">login</a> untuk mengubah daftar pemantauan.",
...
"watchdetails" => "($1 halaman dipantau [tidak termasuk halaman pembicaraan]; $2 halaman berubah sejak cutoff; $3... <a href='$4'>lihat dan sunting daftar lengkap</a>.)",
...
"movenologintext" => "Anda harus menjadi pengguna terdaftar dan telah <a href=\"{{localurl:Special:Userlogin}}\">login</a> untuk memindahkan halaman.",
...
'sitesettings-permissions'      => 'Izin',
'sitesettings-memcached'        => 'Daemon Memcache',
'sitesettings-debugging'        => 'Debugging',
'sitesettings-caching'          => 'Cache halaman',
'sitesettings-wgShowIPinHeader' => 'Tampilkan IP di judul (hanya untuk pengguna yang belum login)',
'sitesettings-wgUseDatabaseMessages' => 'Gunakan pesan yang ada di basis data untuk teks antarmuka pengguna',
'sitesettings-wgUseCategoryMagic' => 'Aktifkan kategori',
'sitesettings-wgUseCategoryBrowser' => 'Aktifkan tampilan kategori bergaya dmoz (percobaan). Contoh keluaran: Ensiklopedi > Musik > Jenis Musik > Jazz',
'sitesettings-wgHitcounterUpdateFreq' => 'Frekuensi pembaruan hit counter',
'sitesettings-wgAllowExternalImages' => 'Izinkan gambar luar dalam artikel',
'sitesettings-permissions-readonly' => 'Modus perawatan: Matikan akses tulis',
'sitesettings-permissions-whitelist' => 'Modus Whitelist',
'sitesettings-permissions-banning' => 'Pemblokiran pengguna',
'sitesettings-permissions-miser' => 'Pengaturan performa',
'sitesettings-wgReadOnly' => 'Modus baca-saja',
'sitesettings-wgReadOnlyFile' => 'File pesan baca-saja',
'sitesettings-wgWhitelistEdit' => 'Pengguna harus login agar dapat menyunting',
'sitesettings-wgWhitelistRead' => 'Pengguna anonim hanya dapat membaca halaman-halaman berikut:',
'sitesettings-wgWhitelistAccount-user' => 'Pengguna dapat membuat akun sendiri',
'sitesettings-wgWhitelistAccount-sysop' => 'Sysop dapat membuatkan akun untuk pengguna',
'sitesettings-wgWhitelistAccount-developer' => 'Pengembang dapat membuatkan akun untuk pengguna',
'sitesettings-wgSysopUserBans' => 'Sysops dapat memblokir pengguna yang login',
'sitesettings-wgSysopRangeBans' => 'Sysops dapat memblokir blok IP',
'sitesettings-wgDefaultBlockExpiry' => 'Secara baku, blokir akan kadaluarsa setelah:',
'sitesettings-wgMiserMode' => 'Gunakan modus "miser" yang mematikan banyak fitur "mahal"',
'sitesettings-wgDisableQueryPages' => 'Jika dalam modus miser, matikan semua halaman kueri, tidak hanya yang "mahal" saja',
'sitesettings-wgUseWatchlistCache' => 'Buat daftar pemantauan secara rutin',
'sitesettings-wgWLCacheTimeout' => 'Setiap (dalam detik):',
'sitesettings-cookies' => 'Cookies',
'sitesettings-performance' => 'Performa',
